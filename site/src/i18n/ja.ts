...
export const ja: Catalog = {
  ...
  "home.limits.scripts.heading": "横書きのみ",
  ...
  "home.limits.a11y.heading": "スクリーンリーダー、ただし境界あり",
  "home.limits.a11y.body":
    "ウィンドウは UI Automation・NSAccessibility・AT-SPI2 に自分を公開するので、NVDA・VoiceOver・Orca が Limn のインターフェイスを、それが描かれている言語で読み上げます。テキストは丸ごと読み書きするため、文字単位のレビューと点字カーソルのルーティングは制限されます。リストは実体化した行だけを公開します。そして高コントラスト、視差効果の軽減、文字サイズといった OS のアクセシビリティ設定は一切公開していません。",
