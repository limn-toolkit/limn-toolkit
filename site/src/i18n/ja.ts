...
export const ja: Catalog = {
  ...
  "home.limits.scripts.heading": "文字は整形される。レイアウトは鏡像化されない",
  "home.limits.scripts.body":
    "アラビア文字、ヘブライ文字、デーヴァナーガリー、タイ文字は、テキストが描かれるところならどこでも結合し、並べ替わり、記号も正しい位置に付きます——Label、TextField、TextArea の中でも、その周りのボタン、タブ、メニュー項目、プレースホルダーでも同じです。ar と he の翻訳も配布します。右から左に読む言語が得られないのはレイアウトのほうです。余白も、揃えも、スクロールバーの位置も、ポップアップの開く側も、テキストフィールドの外で矢印キーがどちらへ進むかも、言語によらず左から右です。",
