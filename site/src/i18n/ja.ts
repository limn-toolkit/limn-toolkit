...
export const ja: Catalog = {
  ...
  "consent.title": "このサイトは Cookie を使いません",
  ...
  "consent.analyticsBody":
    "現在これを使っているものはありません。このサイトはアクセス解析を一切同梱していません。将来なにかが訪問を計測するようになっても、ここで許可するまで動かないようにするためのスイッチです。",
  ...
  "privacy.description":
    "このサイトが保存するもの、しないもの、そして選択を変える方法。Cookie なし、アクセス解析なし、サードパーティへのリクエストなし。",
  "privacy.eyebrow": "プライバシー",
  "privacy.heading": "このサイトが保存するもの",
  "privacy.lede":
    "短く言えば、Cookie なし、アクセス解析なし、サードパーティへのリクエストなし、あなたを特定するものもなし。長い版は下にあります。短い版は、長い版が同じことを言っているときにだけ読む価値があるからです。",
  ...
  "privacy.cookies.heading": "Cookie は一切なし",
  "privacy.cookies.body":
    "このサイトはいかなる Cookie も設定しないので、リクエストに何かが付いて回ることも、他のサイトまであなたを追いかけることもありません。ローカルストレージは Cookie ではありません。送信されることはなく、サーバーが要求することもできません。",
  "privacy.analytics.heading": "アクセス解析はなし、それでもスイッチはある",
  "privacy.analytics.body":
    "解析ツールもタグマネージャーもトラッキングピクセルもありません。プライバシーの確認にある計測スイッチは既定でオフで、今後追加されうるものすべてを制御します。そのカテゴリのスクリプトは動かない形で配置され、あなたが許可したときにはじめて実行されるスクリプトに変わります。",
  "privacy.thirdParty.heading": "外部から読み込むものはなし",
  "privacy.thirdParty.body":
    "フォントも画像もスタイルシートもスクリプトも、すべてこのドメインから届きます。ウェブフォントのサービスも CDN も、埋め込み動画もソーシャルウィジェットもありません。だからここのページを読むと、通信先はちょうど 1 台のサーバーだけです。",
