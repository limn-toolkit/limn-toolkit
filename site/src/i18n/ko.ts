...
export const ko: Catalog = {
  ...
  "home.limits.scripts.heading": "셰이핑은 되지만 배치는 뒤집히지 않음",
  "home.limits.scripts.body":
    "아랍 문자, 히브리 문자, 데바나가리, 타이 문자는 텍스트가 그려지는 곳이라면 어디서나 결합하고 재배열되며 기호도 제자리에 놓입니다. Label, TextField, TextArea 안에서도, 그 바깥의 버튼과 탭과 메뉴 항목과 자리 표시자에서도 그렇습니다. ar과 he 번역도 배포합니다. 오른쪽에서 왼쪽으로 읽는 언어가 얻지 못하는 것은 배치입니다. 안쪽 여백도, 정렬도, 스크롤 막대가 놓이는 쪽도, 팝업이 열리는 쪽도, 텍스트 필드 바깥에서 화살표 키가 옮겨 가는 쪽도 언어와 무관하게 왼쪽에서 오른쪽입니다.",
