...
export const zhHans: Catalog = {
  ...
  "home.try.body":
    "演示与主题编辑器，直接来自 Maven Central。无需克隆；没有 JDK 时 jbang 会自动获取。",
  ...
  "home.languages.body":
    "拉丁、希腊、西里尔与中日韩文字可混在同一个字符串里，字体逐字选择。阿拉伯文、希伯来文、天城文和泰文会被正确塑形——连写、合字、附加符号——从右到左的语言则让整个窗口镜像：行、边距、滚动条、方向键。输入法在字段内组字，编辑按字素移动。",
  "home.languages.alt":
