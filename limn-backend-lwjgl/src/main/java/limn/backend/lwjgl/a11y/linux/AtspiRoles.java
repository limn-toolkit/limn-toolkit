...
final class AtspiRoles {
    ...
    /**
     * Whether a node of this role is a row of a menu — the shape AT-SPI's first declared
     * exception is about.
     *
     * <p>A menu row that owns a submenu is what a GTK 3 desktop calls a <b>menu title</b>, and it
     * is the only node this predicate changes anything for: a row with no submenu carries no expand
     * axis to remove. Read on the Fedora 44 guest, 2026-09-16
     ...
     * carries when open is {@code selected}, its children gain {@code showing}, and every menu node
     * is {@code selectable}.
     *
     * <p>By the role and not by the widget, because a bridge reads nodes: a combo box, a tree row
     * and a calendar's title are not menus and keep the axis.
     */
