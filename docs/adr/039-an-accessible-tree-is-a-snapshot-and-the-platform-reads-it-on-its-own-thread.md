...
26. **~~`AccessibleGalleryTest` runs against eighty scenes and has no reference answer.~~ Closed
    ...
    it is simplified. The gallery-wide invariant test stays
