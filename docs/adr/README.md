...
| [039](039-an-accessible-tree-is-a-snapshot-and-the-platform-reads-it-on-its-own-thread.md) | An accessible tree is a snapshot, and the platform reads it on its own thread | Accepted, 2026-09-04; implemented 2026-09-07, all of §14, the three bridges read by NVDA, VoiceOver and Orca | Delivers [006](006-i18n.md) §5's promise that an accessibility API's labels are `I18nString`s |
| [040](040-a-handler-answers-the-user-and-a-watcher-hears-everything.md) | A handler answers the user, and a watcher hears everything | Proposed, 2026-09-03; nothing implemented | Four of its open items — §6.1 to §6.4 — are answered in design by [039](039-an-accessible-tree-is-a-snapshot-and-the-platform-reads-it-on-its-own-thread.md) §9.2 |
