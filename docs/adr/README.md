...
| [039](039-an-accessible-tree-is-a-snapshot-and-the-platform-reads-it-on-its-own-thread.md) | An accessible tree is a snapshot, and the platform reads it on its own thread | Proposed, 2026-09-04; nothing implemented | Delivers [006](006-i18n.md) §5's promise that an accessibility API's labels are `I18nString`s |
